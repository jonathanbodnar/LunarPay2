<style>
    #nav-pills-tabs-organizations,
    #nav-pills-tabs-sub-organizations {
        border-bottom: none;
        border-left: none;
        border-right: none;
        padding: 0
                    ...
                    <div id="nav-pills-tabs-organizations" class="tab-pane tab-example-result fade show active" role="tabpanel" aria-labelledby="nav-pills-tabs-organizations-tab">
                        <div class="card-header card-header-orgs">
                            <div class="row">
                                ...
                                <!-- <div class="col-sm-6">
                                    <button class="btn btn-outline-neutral float-right top-table-bottom btn-add-organization just-dev" data-toggle="modal">
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            <label class="tooltip-help" data-toggle="tooltip" data-html="true" data-placement="right" title='<?php $this->load->view('helpers/text_to_give_instructions') ?>'>
                                                ?
                                            </label>
                                        </th>
                                        ...
                                        <th>
                                            ...
                                            <!-- <label class="tooltip-help" data-toggle="tooltip" data-placement="right" title="We need to review and approve your application before payments can be accepted.">
                                                ?
                                            </label> -->
                                        </th>
                                        <th>Bank</th>
                    ...
                    <div id="nav-pills-tabs-sub-organizations" class="tab-pane fade" role="tabpanel" aria-labelledby="nav-pills-tabs-sub-organizations-tab">
                        <div class="card-header card-header-orgs">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <button class="btn btn-outline-neutral float-right top-table-bottom btn-add-suborganization" data-toggle="modal">
                                        <i class="fas fa-plus"></i>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive py-4 table-orgs2">
                            <!-- comment <div id="suborganizations_datatable_div_organization_filter" class="col-md-3 col-sm-12 d-inline-block p-1" style="display: none;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input maxlength="10" class="form-control" id="phone_number1" name="step1[phone_number]" placeholder="<?= langx('Merchant\'s phone number') ?>" type="number" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input maxlength="10" type="number" class="form-control" id="averageTransactionAmount" placeholder="$" name="step1[averageTransactionAmount]" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input maxlength="10" class="form-control" id="phoneDescriptor" name="step1[phoneDescriptor]" placeholder="<?= (langx('Phone Descriptor')) ?>" type="number" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input maxlength="9" default-length="9" europe-length="30" class="form-control" id="federalTaxNumber" name="step1[federalTaxNumber]" placeholder="<?= langx('Federal Tax Number') ?>" type="number" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input maxlength="10" class="form-control" id="phone_number2" name="step3[phone_number]" placeholder="<?= langx('phone_number') ?>" type="number" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                </div>
                            </div>
                                ...
                                <div class="row bank_type wire_type hide">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" maxlength="20" class="form-control" id="wire_account_number" name="step4[wire_account_number]" placeholder="<?= langx('Account number') ?>" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <?php echo langx('Swift Number:', 'wire_swift_number'); ?> <br />
                                            <input type="number" maxlength="20" class="form-control" id="wire_swift_number" name="step4[wire_swift_number]" placeholder="<?= langx('Swift Number') ?>" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                ...
                                <div class="row bank_type sepa_type hide">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" maxlength="20" class="form-control" id="sepa_swift_number" name="step4[sepa_swift_number]" placeholder="<?= langx('Swift Number') ?>" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <?php echo langx('IBAN Number:', 'sepa_iban_number'); ?> <br />
                                            <input type="number" maxlength="20" class="form-control" id="sepa_iban_number" name="step4[sepa_iban_number]" placeholder="<?= langx('IBAN Number') ?>" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                    </div>
                                </div>
                                <div class="row bank_type bacs_type hide">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" maxlength="8" class="form-control" id="bacs_account_number" name="step4[bacs_account_number]" placeholder="<?= langx('Account number') ?>" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <?php echo langx('Sort Code:', 'bacs_sort_code'); ?> <br />
                                            <input type="number" maxlength="6" class="form-control" id="bacs_sort_code" name="step4[bacs_sort_code]" placeholder="<?= langx('Sort Code') ?>" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                    </div>
                                </div>
                                <div class="row bank_type eft_type hide">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" maxlength="20" class="form-control" id="eft_account_number" name="step4[eft_account_number]" placeholder="<?= langx('Account number') ?>" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?php echo langx('Transit Number:', 'eft_transit_number'); ?> <br />
                                            <input type="number" maxlength="5" class="form-control" id="eft_transit_number" name="step4[eft_transit_number]" placeholder="<?= langx('Transit number') ?>" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row bank_type ach_type hide">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" maxlength="20" class="form-control" id="account_number" name="step4[ach_account_number]" placeholder="<?= langx('Account number') ?>" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?php echo langx('Nine-digit Bank routing number:', 'routing_number'); ?> <br />
                                            <input type="number" maxlength="9" class="form-control" id="routing_number" name="step4[ach_routing_number]" placeholder="<?= langx('Routing number') ?>" value="" oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">
                    <?= langx('save_sub_organization') ?>
                    <span style="font-size: 12.7px; padding-top: 20px; line-height: 24px; font-weight: normal; font-style: italic; display: none" class="header-label show-when-add-sub-organization">
                        <br>
                        <?= langx('to') ?>
