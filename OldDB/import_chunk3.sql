...
CREATE TABLE IF NOT EXISTS "payment_link_products" (
  ...
  "is_editable" tinyINTEGER NOT NULL DEFAULT 0,
  "qty" INTEGER NOT NULL,
  "is_qty_unlimited" tinyINTEGER NOT NULL DEFAULT 0
);
...
) ENGINE=InnoDB =17 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
CREATE TABLE IF NOT EXISTS "payment_links" (
  ...
  "show_post_purchase_link" tinyINTEGER DEFAULT NULL,
  "post_purchase_link" VARCHAR(255) DEFAULT NULL,
  "is_internal" tinyINTEGER DEFAULT NULL,
  "trial_days" INTEGER DEFAULT NULL,
  "payment_methods" VARCHAR(100) NOT NULL,
  "cover_fee" tinyINTEGER DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "products" (
  ...
  "show_customer_portal" tinyINTEGER DEFAULT NULL,
...
) ENGINE=InnoDB =14 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
CREATE TABLE IF NOT EXISTS "tags" (
  ...
  "created_at" TIMESTAMP DEFAULT NULL,
  UNIQUE KEY "client_id_name_scope" ("client_id","name","scope")
);
...
CREATE TABLE IF NOT EXISTS "users" (
  ...
  "active" tinyINTEGER DEFAULT NULL,
  ...
  "force_logout" tinyINTEGER DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "users_groups" (
  "id" mediumINTEGER NOT NULL ,
  "user_id" mediumINTEGER NOT NULL,
  "group_id" mediumINTEGER NOT NULL
);
...
) ENGINE=InnoDB =19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
