    ...
    var organizations = {
        ...
        setorganizations_dt: function () {
            this.dtTable = $(tableId).DataTable({
                ...
                columns: [
                    {data: "ch_id", visible: false, className: "text-center", "render": $.fn.dataTable.render.text()},
                    {
                        data: "church_name", "render": function (data, type, full) {
                            ...
                            return `<span style="margin-left:10px">${str}</span>`;
                        }
                    },
                    {data: "phone_no", className: "", "render": $.fn.dataTable.render.text(), visible: false},
                    {
                        data: "ch_id", className: "text-center", orderable: false, visible: false,
                    ...
                    {data: "street_address", className: "", "render": $.fn.dataTable.render.text(), visible: true},
                    {
                        data: "ch_id", className: "text-center", orderable: false,
                        "render": function (data, type, full) {
                            return `<a style="color:#525f7f" href="${base_url}"><strong>${full.app_status}</strong></a>`;
                        }
                    },
                    {
                        data: "account_number_last4", className: "text-center", orderable: false,
                        "render": function (data, type, full) {
                            return `<strong>•••• ${data}</strong>`;
                        }
                    },
                    {
                        data: "ch_id", className: "", searchable: false, visible: false, mRender: function (data, type, full) {
